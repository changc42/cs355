...
const endpoints = require("../server/auth/endpoints");
const {
  client_id,
  client_secret,
  state,
  API_KEY,
} = require("../server/auth/keys");
const scopes = require("../server/auth/scopes");
let createMyMessageList = require("../server/utilFunctions/createMyMessageList");
const { spawn } = require("child_process");
let moreReducedMsg = require("../server/utilFunctions/moreReducedMsg");
